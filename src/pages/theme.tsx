...
const Theme: NextPage = () => {
  return (
    <ContentDemoPage title="Bulma Theme">
      <div className="columns is-centered">
        <CardDemo title="bulma theme" demo="pages/theme.tsx" code="styles/global.scss">
          <p>
            I use a simple CSS framework called Bulma. It is perfect to prototype an application quickly.
            This page lets you test a theme, you could copy the HTML or copy the react code to test your theme.
          </p>
        </CardDemo>
      </div>
      <hr />
      <div className="block">
        ...
        <div className="buttons">
          <a className="button is-light">Button</a>
      ...
      <section className="hero my-2 is-light">
        <div className="hero-head">
          <nav className="navbar">
            <div className="container">
              <div className="navbar-start">
                <h1 className="navbar-item" id="title">
                  My Theme
                </h1>
      ...
      <div className="block">
        <div className="content">
          ...
          <figure>
            <img alt="a gray placeholder" src="https://bulma.io/images/placeholders/256x256.png" />
            <img alt="a gray placeholder" src="https://bulma.io/images/placeholders/256x256.png" />
            <figcaption>
